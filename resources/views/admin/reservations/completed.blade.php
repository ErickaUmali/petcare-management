...
@section('styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/reservations/completed.css') }}">
@endsection
    ...
    <div class="dashboard-main-container">
        ...
        <main>
            <header>
                <div>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <form action="{{ route('reservations.completed') }}" method="GET" class="modal-content">
                ...
                <form action="{{ route('reservations.completed.print') }}" method="POST" class="button-container">
                    @csrf
            ...
            <section>
                ...
                @empty
                    <div class="empty">There are currently no completed reservations.</div>
                @endforelse
            </section>
        </main>
    </div>
