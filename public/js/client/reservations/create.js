...
"use strict";
/*!****************************************************!*\
  !*** ./resources/js/client/reservations/create.js ***!
  \****************************************************/
__webpack_require__.r(__webpack_exports__);
...
var petContainer = document.querySelector('.pet');
var petContainerSelect = petContainer.querySelector('select');
petContainerSelect.addEventListener('change', getPetProfile);
getPetProfile();

function getPetProfile() {
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/pets/profile', {
    params: {
    ...
    var petProfile = response.data.profile;
    petProfile = petProfile.replace('public', 'storage');
    console.log(petProfile);
    imageDiv.style.backgroundImage = "url('/".concat(petProfile, "')");
...
var tommorow = moment__WEBPACK_IMPORTED_MODULE_2___default()().add(1, 'd').toDate();
var maxDate = moment__WEBPACK_IMPORTED_MODULE_2___default()().add(60, 'd').toDate();
var availableTimes = [];
var takenTimes = [];
axios__WEBPACK_IMPORTED_MODULE_0___default().get('/reservations/times', {}).then(function (response) {
...
axios__WEBPACK_IMPORTED_MODULE_0___default().get('/reservations/between', {
  params: {
    min: tommorow,
    max: maxDate
  }
  ...
  var counts = {};
  var dbTimes = response.data;
  var excludeDates = [];
  dbTimes.forEach(function (x) {
...
function datepickerChange() {
  ...
  takenTimes = [];
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/reservations/taken', {
    params: {
    ...
    var difference = availableTimes.filter(function (x) {
      return !takenTimes.includes(x);
    });
    difference.forEach(function (time) {
...
function addChildToElement(parent, childElementType, childElementValue) {
  var element = document.createElement(childElementType);
